...
Este é um projeto template/boilerplate que serve como base para iniciar todos os outros projetos. Ele contém a estrutura padrão de pastas, arquivos base e estas diretrizes de desenvolvimento que devem ser seguidas consistentemente em todos os projetos derivados.

## Perfil do desenvolvedor

- **Idioma**: sempre comunicar em português brasileiro (pt-br)
- **Especialidades técnicas**: PHP, HTML5, CSS3 e JavaScript
