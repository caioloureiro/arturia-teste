...
-- 2. Crie um banco de dados chamado: arturiateste
-- 3. Selecione o banco arturiateste
-- 4. Vá na aba "SQL"
-- 5. Cole este código completo e clique em "Executar"
-- ================================================

-- Apagar tabelas se já existirem (cuidado em produção!)
...
-- VERIFICAÇÃO
-- ================================================
-- Execute estas queries para confirmar a instalação:
